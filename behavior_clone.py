...
if train_ppo:
    ...
    ppo_agent.actor.load_state_dict(torch.load('ppo_actor.pth', map_location=device))
    ppo_agent.critic.load_state_dict(torch.load('ppo_critic.pth', map_location=device))
